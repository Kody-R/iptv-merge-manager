...
git init
git add .
git commit -m "IPTV Merge Manager v0.3.0"
git branch -M main
...
`ghcr.io/YOUR_GITHUB_USERNAME/iptv-merge-manager:0.3.0`
...
4. Change the CasaOS image tag from `0.3.0` to `0.3.1` and update/recreate the app.
